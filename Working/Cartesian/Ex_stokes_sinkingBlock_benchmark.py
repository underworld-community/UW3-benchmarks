...
# %%
### Key ND values
ND_gravity     = ndim(10*u.meter/u.second**2)
...
# %%
xmin, xmax = 0., ndim(512*u.kilometer)
ymin, ymax = 0., ndim(512*u.kilometer)

# %%
# Set the box min and max coords
boxCentre_x, boxCentre_y = ndim(256.0*u.kilometer), ndim(384.0*u.kilometer)

box_xmin, box_xmax = boxCentre_x-ndim(64*u.kilometer), boxCentre_x+ndim(64*u.kilometer)
box_ymin, box_ymax = boxCentre_y-ndim(64*u.kilometer), boxCentre_y+ndim(64*u.kilometer)
...
# %%
uw.function.evaluate(v.sym[1], tracer)*(ndim(1e21*u.pascal*u.second)/ndim(dRho*u.kilogram/u.meter**3))

# %%
# array([-2.41090611e+26])

# %%
(dim(uw.function.evaluate(v.sym[1], tracer), u.meter/u.second)*1e21/dRho).m

# %%
# array([-1.23438393e+10])
